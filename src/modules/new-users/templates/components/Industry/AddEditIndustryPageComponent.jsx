...
export class AddEditIndustryPageComponent extends Component {
      ...
      (res) => {
        let tempObj =
          ...
          res.industry.map((prop) => {
            return {
              id: prop.id,
              industry_name: prop.industry_name,
              value: false,
              prop: prop
            };
          });
  ...
  onSubmit = () => {
    let _this = this;
    let tempObj = JSON.parse(JSON.stringify(this.state.industry));
      ...
      if (_this.state.id === null) {
        createIndustry(
          ...
          () => {
            ...
            successAlert("Industry created successfully!", _this);
            _this.fetchDataFromServer();
          },
          () => {
            _this.setState({ loading: false });
        ...
        updateIndustry(
          ...
          () => {
            ...
            successAlert("Industry updated successfully!", _this);
            _this.fetchDataFromServer();
          },
          () => {
            _this.setState({ loading: false });
  ...
  deleteRecord = (id) => {
    ...
    deleteIndustry(
      ...
      () => {
        ...
        successAlert("Industry deleted successfully!", _this);
        _this.fetchDataFromServer();
      },
      () => {
        _this.setState({ loading: false });
      ...
      <Fragment>
                              ...
                              <div className="chatbot_edit_ip_main">
                                ...
                                >
                                  <Form.Control
                                    ...
                                    value={_this.state.industry.industry_name}
                                    onChange={(e) => {
                                      let temp = _this.state.industry;
                                      temp.industry_name = e.target.value;
                                      _this.setState({
                                        industry: temp
                                      });
                                    }}
                                  ...
                                  <div className="errorMsg">
                                    {_this.validator.message(
                                      "industry name",
                                      _this.state.industry.industry_name,
                                      "required"
                                    )}
                                  </div>
                                </FloatingLabel>
        ...
        <DialogActions>
          <Button
            type="button"
            onClick={() => {
              _this.props.setShowIndustryModal(false);
            }}
            variant="contained"
            className="cancel_btn"
          >
...
export default AddEditIndustryPageComponent;
