...
export default class AddPhoneNumberComponent extends Component {
  static contextType = AlertContext;
  constructor(props) {
    super(props);
    this.defaultHtml = "Please type your phone number";
    ...
    this.state = {
      ...
      leads: 1,
      lead_tag: "PHONE",
      message_error: "Invalid phone number",
      total_phone_number_length: 10,
      save: false,
      defaultHtml: "<p>Please type your phone number</p>",
      editordata: "",
    };
    ...
    this.myRef = {
      ...
      options: {
        number_length: this.state.total_phone_number_length,
      },
    };
        ...
        (res) => {
          ...
          if (res.status === "True") {
            ...
            const updateState = {
              ...
              total_phone_number_length: res.total_phone_number_length,
  ...
  handleSave = () => {
    ...
    const data = {
      ...
      total_phone_number_length: this.state.total_phone_number_length,
    };
        ...
        <section className="add-chat-block-section">
          ...
          <div className="main-section">
            <div className="chat-msg-block">
                  ...
                  <div className="button_component">
                    ...
                    <div>
                      ...
                      {/* <Form.Group
                        ...
                        controlId="formTagCheckbox"
                      >
                        <Form.Label>Tags</Form.Label>
                        <Form.Control type="text" placeholder="" value={this.state.lead_tag} onChange={this.handleInputChange} data-label="lead_tag"/>
                      </Form.Group> */}
              ...
              <div className="digits-section-block">
                <label htmlFor="Message">Message</label>
                <div className="digits-block">
                  <div className="max-min-block">
                    <div className="max-block">
                      <label htmlFor="Digits">Maximum Length</label>
                      <div className="input_number_digits">
                        <input
                          type="number"
                          value={this.state.total_phone_number_length}
                          onChange={this.handleInputChange}
                          data-label="total_phone_number_length"
                        />
                      </div>
                    </div>
                  </div>
                  <div className="error-msg-block">
                    ...
                    >
                      <Form.Control
                        ...
                        onChange={this.handleInputChange}
                        data-label="message_error"
                      />
                    </Form.Group>
                    <p>Error message when visitor enters invalid answer</p>
                  </div>
                </div>
              </div>
            </div>
