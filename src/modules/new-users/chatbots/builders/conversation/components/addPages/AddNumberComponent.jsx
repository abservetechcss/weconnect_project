...
export default class AddNumberComponent extends Component {
  static contextType = AlertContext;
  Hello;
  constructor(props) {
    super(props);
    this.defaultHtml = "Enter a number";
    ...
    this.state = {
      ...
      save: false,
      defaultHtml: "<p>Enter a number</p>",
      editordata: "",
    };
  ...
  refreshComponent(noUpdate) {
    ...
    this.myRef.options = {
      ...
      maximum_digit: this.state.minimum_digit,
    };
  ...
  handleSave = () => {
    ...
    if (parseInt(data.minimum_digit) > parseInt(data.maximum_digit)) {
      let temp = data.maximum_digit;
      data.maximum_digit = data.minimum_digit;
      data.minimum_digit = temp;
    }
                ...
                <div className="digits-block">
                  <div className="max-min-block">
                    <div className="min-block">
                      <label htmlFor="Digits">Minimum Digits</label>
                      <div className="input_number_digits">
                        <input
                          type="number"
                          value={this.state.minimum_digit}
                          onChange={this.handleInputChange}
                          data-label="minimum_digit"
                        />
                      </div>
                    </div>
                    <div className="max-block">
                      <label htmlFor="Digits">Maximum Digits</label>
                      <div className="input_number_digits">
                        <input
                          type="number"
                          value={this.state.maximum_digit}
                          onChange={this.handleInputChange}
                          data-label="maximum_digit"
                        />
                      </div>
                    </div>
                  </div>
