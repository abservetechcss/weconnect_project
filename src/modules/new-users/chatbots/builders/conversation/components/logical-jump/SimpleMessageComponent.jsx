...
import { createLogicalJumpComp,getLogicalJumpComp } from "../../BuilderConversaionServer.js";
import { successAlert } from "../../../../../../../js/alerts.js";
export class SimpleMessageComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      question_lists: [],
        ...
        <section className="add-chat-block-section">
          <div className="knowledge_header">
            ...
            >
              ...
              <div>
                <p>Logical jump for: Simple Message</p>
                <p
...
export default SimpleMessageComponent;
