...
export class JumpNumberComponent extends Component {
  constructor(props) {
    super(props);
                    ...
                    <div
                      className={
                        prop.condition === "between"
                          ? "jump_welcome_wrap jump_welcome_gap"
                          : "jump_welcome jump_welcome_gap"
                      }
                    >
                      <FloatingLabel
...
export default JumpNumberComponent;
