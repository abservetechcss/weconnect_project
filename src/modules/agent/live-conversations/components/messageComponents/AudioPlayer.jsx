...
import { BsPlayCircleFill, BsPlayCircle, BsFillPauseCircleFill, BsFillCircleFill,   } from "react-icons/bs";
import "../../../../../assets/scss/audio_player.scss"
...
export default memo(function AudioPlayer({audioUrl, sender, audioPlayed}) {
	...
	return (
		<>
			<div className={`${"audioplayer audioplayer_user"} ${audioPlayed ? "audioplayer__played" : ""}`}>
				{!mediaLoaded && !error ?
					<BsFillCircleFill />
				: isPlaying && !error? 
