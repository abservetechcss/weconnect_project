...
const ThreadMessageComponent = (props) => {
  ...
  return (
    <Accordion.Item eventKey={props.eventKey}>
        ...
        <div className="reply_thread_box">
          ...
          <div className="vistor_thread_right">
            ...
            <p className="visitor_subtext">
              ...
              {`${moment(props.message.datetime).format("dddd").substring(0, 3)}
                ${moment(props.message.datetime).format("MM/DD/yyyy hh:mm A")}`}
            </p>
      ...
      <Accordion.Body>
        <p dangerouslySetInnerHTML={{ __html: props.message.messages }} />
