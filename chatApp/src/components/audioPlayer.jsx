...
import BsPlayCircleFill from "../assets/react-icons/BsPlayCircleFill";
import BsPlayCircle from "../assets/react-icons/BsPlayCircle";
import BsFillPauseCircleFill from "../assets/react-icons/BsFillPauseCircleFill";
import BsFillCircleFill from "../assets/react-icons/BsFillCircleFill";
...
export default memo(function AudioPlayer({ audioUrl, sender, audioPlayed }) {
	...
	return (
		<>
			<div className={`${sender ? "audioplayer audioplayer_user" : "audioplayer audioplayer2"} ${audioPlayed ? "audioplayer__played" : ""}`}>
				{!mediaLoaded && !error ?
					<BsFillCircleFill />
					: isPlaying && !error ?
						<BsFillPauseCircleFill className="pause" onClick={pause} />
						: !isPlaying && !error ?
							<BsPlayCircle onClick={play} />
							:
							<BsPlayCircleFill onClick={loadAudioAgain} />
				}
