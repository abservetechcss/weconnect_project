...
export const UPDATE_MESSAGE_COMPONENT = 'updateMessageComponent'
export const UPDATE_LAST_MESSAGE_COMPONENT = 'updateLastMessageComponent'
...
export const SET_WEBSOCKET_ACTIVE = 'setWebsocketActive'
export const UPDATE_JWT = 'updateJwt'
export const UPDATE_READ_MESSAGE = 'updatereadMessage'
